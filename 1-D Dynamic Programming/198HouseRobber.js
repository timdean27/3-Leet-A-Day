...
let rob =(nums) =>{
 ...
 for (let i = 2; i < nums.length; i++){
        // in this case DP starts at DP[0,1] = [2,2]
        // when i = 2 DP[2] is either nums[2]+DP[2-2]  = 2+2, DP[2-1] = 2
        //DP = [2,2,4]
        // when i = 3 DP[3] is either nums[3]+DP[3-2]  = 1+2, DP[3-1] = 4
        //DP = [2,2,4,4]
        // when i = 4 DP[4] is either nums[4]+DP[4-2]  = 5+4, DP[4-1] = 4
        //DP = [2,2,4,4,9]
         // when i = 5 DP[5] is either nums[5]+DP[5-2]  = 2+4, DP[5-1] = 9
        //DP = [2,2,4,4,9,9]
         // when i = 6 DP[6] is either nums[6]+DP[6-2]  = 9+1, DP[6-1] = 9
        //DP = [2,2,4,4,9,9,10]
