...
if(amount[0]+amount[1]<amount[2]){
    ...
    let x = (amount[2]+amount[1]+amount[0])
    if(x % 2 == 0){
    return (x / 2)
    }
    else{return Math.round(x / 2)}
...
//7
console.log(fillCups([5,4,2]))
//6
console.log(fillCups([5,4,3]))
//6
console.log(fillCups([5,3,3]))
//6
console.log(fillCups([5,5,4]))
//7